import type { InputFormProps } from "../types/forms.type" 
 ...
 export default function InputForm({id,type,placeHolder,className,registerName,onKeyDown,...rest}:InputFormProps){
  ...
  return (
    <input id={id} type={type} placeholder={placeHolder} className={`${baseClassname} ${className}`} {...rest} onKeyDown={(e)=>{ if(onKeyDown) {onKeyDown(e)}}}/>
  )
